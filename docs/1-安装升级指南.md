...
Debian 13 iso 安装镜像: [官方下载](https://cdimage.debian.org/debian-cd/current/amd64/iso-dvd/) | [兰州大学镜像（推荐）](https://mirror.lzu.edu.cn/debian-cd/current/amd64/iso-dvd/) | [163镜像](https://mirrors.163.com/debian-cd/current/amd64/iso-dvd/)   
