...
apt install curl -y 
# 安装 Landscape Router
curl -fsSL https://raw.githubusercontent.com/CyberRookie-X/Install_landscape_on_debian12_and_manage_compose_by_dpanel/main/install_landscape.sh | bash
...
apt install curl -y 
# 安装 Landscape Router
curl -fsSL https://ghfast.top/https://raw.githubusercontent.com/CyberRookie-X/Install_landscape_on_debian12_and_manage_compose_by_dpanel/main/install_landscape.sh | bash
